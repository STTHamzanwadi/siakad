...
public class OprLembagaMenuComponent extends CustomComponent {
	...
	public OprLembagaMenuComponent() {
	...
	private Component buildUserMenu() {
		...
		settingsItem.addItem("Sign Out", new Command() {
			@Override
			public void menuSelected(MenuItem selectedItem) {
				VaadinSession.getCurrent().setAttribute(UserOprInstansi.class, null);
	...
	private Component buildTitle() {
		Label logo = new Label("<strong>PANGKALAN DATA TERPADU</strong>",
				ContentMode.HTML);
		logo.setSizeUndefined();
		Label lbl=new Label("<strong>YAYASAN PENDIDIKAN HAMZANWADI</strong>",
				ContentMode.HTML);
		...
		UserOprInstansi user = (UserOprInstansi) VaadinSession.getCurrent().getAttribute(
				UserOprInstansi.class);
		Label lblInstansi=new Label("Login As: "+user.getInstansi().toString());
		lblInstansi.setSizeUndefined();
		VerticalLayout logoWrapper = new VerticalLayout(logo,lbl,lblInstansi);
		logoWrapper.setComponentAlignment(logo, Alignment.MIDDLE_CENTER);
		
		logoWrapper.setComponentAlignment(lblInstansi, Alignment.MIDDLE_CENTER);
		logoWrapper.setComponentAlignment(lbl, Alignment.MIDDLE_CENTER);
	...
	public class ValoMenuItemButton extends Button {
		...
		public ValoMenuItemButton(final OprLembagaMenuItems view) {
