...
public class DaftarProdi extends Panel implements View{
	...
	private Component getTable(){
		...
		List<Prodi> pr =PegawaiPersistence.getProdiByLembaga(user.getInstansi());
	...
	private void tambahProdibaru(Prodi p) {
		final Window win = new Window("Tambah Prodi Baru");
		win.setIcon(FontAwesome.ARROWS);
		Component c = new TambahProdi(p,win);
