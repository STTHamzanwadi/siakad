...
public class MahasiswaNavigator extends Navigator {

    
    private final static MahasiswaMenuItems ERROR_VIEW = MahasiswaMenuItems.DASHBOARD;
    private ViewProvider errorViewProvider;

    public MahasiswaNavigator(ComponentContainer container) {
    ...
    private void initViewChangeListener() {
        addViewChangeListener(new ViewChangeListener() {
            ...
            public void afterViewChange(ViewChangeEvent event) {
                for (MahasiswaMenuItems view : MahasiswaMenuItems.values()) {
